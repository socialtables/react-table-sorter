  ...
  render: function() {
    ...
    var headerExtra = function() {
      return columnNames.map(function(c) {
        return React.createElement("th", {className: "header-extra"}, this.state.columns[c].name);
      }, this);   
    }.bind(this);
    ...
    var cell = function(x) {
      return columnNames.map(function(c) {
        ...
        if (x[c].link){
          return React.createElement("td", null, React.createElement("a", {href: x[c].link}, x[c].text));
        // link defined in config for entire column
         ...
         var link = this.props.config.columns[c].link.replace("{cell}", x[c].text);
          return React.createElement("td", null, React.createElement("a", {href: link}, x[c]));
        // simple cell
        } else {
          return React.createElement("td", null, x[c].text);
        }
      }, this);
    }.bind(this);
    ...
    sortedItems.forEach(function(item, idx) {
      ...
      rows.push(
        React.createElement("tr", {key: keyIndex}, 
           cell(item) 
        )
      );
      keyIndex++;
    ...
    var header = columnNames.map(function(c) {
      return React.createElement("th", {onClick: this.sortColumn(c), className: "header " + this.sortClass(c)}, this.state.columns[c].name);
    }, this);

    var filterInputs = columnNames.map(function(c) {
      return React.createElement("td", null, React.createElement("input", {type: "text", valueLink: filterLink(c)}));
    }, this);
